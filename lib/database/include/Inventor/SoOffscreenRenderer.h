...
class SoOffscreenRenderer {
 public:
  ...
  private:
    ...
    /* SDL port: offscreen rendering is stubbed pending an FBO-based
     * implementation (TODO M5). These members are unused placeholders. */
    void		*display;
    void		*visual;
    void		*context;
    ...
    static SbBool 	initPixmap( void * &dpy, void * &vi,
                                void * &cx, const SbVec2s &sz,
                                unsigned long &glxPmap, unsigned long &xpmap );
