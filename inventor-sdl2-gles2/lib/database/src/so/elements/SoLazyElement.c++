...

{
    ...
    // Emscripten's legacy GL emulation does not implement
    // GL_COLOR_MATERIAL: its lighting shader takes diffuse only from
    // glMaterialfv. Force the glMaterial path so colors are correct.
    value = FALSE;
#endif
