...
/* SDL port: GLX attribute list removed; offscreen contexts are stubbed
   pending an FBO implementation (TODO M5). */
...
////////////////////////////////////////////////////////////////////////
{
    ...
    if (display != NULL) {
        /* SDL port: nothing to destroy in the stub. */
    }
}
...
////////////////////////////////////////////////////////////////////////
{
    /* SDL port: no X display to query; assume 75 dpi like SGI default. */
    return 75.0;
...
////////////////////////////////////////////////////////////////////////
{
    /* SDL port: stub — report a common max viewport. */
    return SbVec2s(4096, 4096);
...
SoOffscreenRenderer::initPixmap(
    ...
    void *        &cx,
    const SbVec2s &sz,
    unsigned long &glxpmap,
    unsigned long &xpmap )

//
////////////////////////////////////////////////////////////////////////
{
    /* SDL port: offscreen pixmap rendering is not yet implemented.
       TODO(M5): FBO-based implementation usable on GLES2/WebGL. */
    (void)dpy; (void)vi; (void)cx; (void)sz; (void)glxpmap; (void)xpmap;
    return FALSE;
