...
////////////////////////////////////////////////////////////////////////
{
	...
	// No cast: arity-changing function-pointer casts trap under wasm.
	realTimeSensor->setFunction(&SoSceneManager::realTimeSensorCB);
#ifdef DEBUG
	if (SoDebug::GetEnv("IV_DEBUG_SENSORS")) {
...
void
SoSceneManager::realTimeSensorCB(void *, SoSensor *)
//
////////////////////////////////////////////////////////////////////////
{
