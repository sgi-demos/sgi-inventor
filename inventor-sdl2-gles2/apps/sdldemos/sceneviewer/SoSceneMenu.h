...
//
// SDL port: same menu tables, with the label strings that the Motif
// version pulled from X resources filled in literally, and no
// XtResource machinery. The tables drive the keyboard help text and
// the menu-action ids.
//
...
static SoSceneViewerButton fileData[] = {
    ...
    {0,    	   0,		     SV_SEPARATOR },
    {"New",	   SV_FILE_NEW,	     SV_PUSH_BUTTON, 0, 0 },
    {"Open...",	   SV_FILE_OPEN,     SV_PUSH_BUTTON, 0, 0 },
    {"Import...",  SV_FILE_IMPORT,   SV_PUSH_BUTTON, 0, 0 },
    {"Save",	   SV_FILE_SAVE,     SV_PUSH_BUTTON, 0, 0 },
    {"Save As...", SV_FILE_SAVE_AS,  SV_PUSH_BUTTON, 0, 0 },
    {0,    	   0,		     SV_SEPARATOR },
    {"Read Environment...", SV_FILE_READ_ENV, SV_PUSH_BUTTON, 0, 0 },
    {"Save Environment...", SV_FILE_SAVE_ENV, SV_PUSH_BUTTON, 0, 0 },
    {0,    	   0,		     SV_SEPARATOR },
    {"Print...",   SV_FILE_PRINT,    SV_PUSH_BUTTON, 0, 0 },
    {"Quit",	   SV_FILE_QUIT,     SV_PUSH_BUTTON, 0, 0 },
};

static SoSceneViewerButton editData[] = {
    {"Pick Parent", SV_EDIT_PICK_PARENT, SV_PUSH_BUTTON, 0, 0 },
    {"Pick All",    SV_EDIT_PICK_ALL, SV_PUSH_BUTTON, 0, 0 },
    {0,    	    0,		      SV_SEPARATOR },
    {"Cut",	    SV_EDIT_CUT,      SV_PUSH_BUTTON, 0, 0 },
    {"Copy",	    SV_EDIT_COPY,     SV_PUSH_BUTTON, 0, 0 },
    {"Paste",	    SV_EDIT_PASTE,    SV_PUSH_BUTTON, 0, 0 },
    {"Delete",	    SV_EDIT_DELETE,   SV_PUSH_BUTTON, 0, 0 },
};
...
//  {name, 	id,	    	subMenu,    subItemCount}
    {"File",    SV_FILE, 	fileData,   sizeof(fileData)/sizeof(fileData[0])   },
    {"Edit",    SV_EDIT, 	editData,   sizeof(editData)/sizeof(editData[0])   },
    {"Viewing", SV_VIEW, 	viewData,   sizeof(viewData)/sizeof(viewData[0])   },
    {"Selection", SV_SELECTION, selData,    sizeof(selData)/sizeof(selData[0])	 },
    {"Editors", SV_EDITOR, 	editorData, sizeof(editorData)/sizeof(editorData[0]) },
    {"Manips",  SV_MANIP, 	manipData,  sizeof(manipData)/sizeof(manipData[0])  },
    {"Lights",  SV_LIGHT, 	lightData,  sizeof(lightData)/sizeof(lightData[0])  }
};
