...
main(int argc, char **argv)
{
...
#ifdef SDL_PORT
    // No usable stdin on the web build: default to the jack-in-the-box
    if (filename == NULL) {
	printf("Reading jackInTheBox.iv"
	       " (pass a filename to view another scene)\n");
	filename = (char *) "jackInTheBox.iv";
    }
#else
    ...
    //
#ifdef SDL_PORT
    sv = new SoSceneViewer(NULL, NULL, TRUE, selRoot, envFile);
    selRoot->unref();
