...
#ifdef SDL_PORT
void
delayCB(void *str, SoSensor *)
{
    updateTextString((const char *)str);
}
void
delayUpdateTextString(const char *str)
{
...
//
#ifdef SDL_PORT
// No X clipboard: write the text scene as Inventor ASCII to stdout.
void
copyTextToStdout()
{
    SoWriteAction wa;
