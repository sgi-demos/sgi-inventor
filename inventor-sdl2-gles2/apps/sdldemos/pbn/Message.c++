...
#ifdef SDL_PORT
#include <stdio.h>
// SDL port: message dialogs become console messages.
int Message::numShown = 0;
Message::Message(Widget, const char *message)
{
    widget = NULL;
    deleteMe = FALSE;
    printf("[PBN] %s\n", message);
...
Message::~Message() {}
void Message::destroyCB(Widget, XtPointer, XtPointer) {}
void Message::okCB(Widget, XtPointer, XtPointer) {}
#else
