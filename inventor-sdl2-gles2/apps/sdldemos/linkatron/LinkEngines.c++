...
//
/////////////////////////////////////////////////////////////
SO_ENGINE_ABSTRACT_SOURCE(CheckingEngine);	// SDL port: abstract base


void
CheckingEngine::initClass()
{
    SO_ENGINE_INIT_ABSTRACT_CLASS(CheckingEngine, SoEngine, "Engine" );
}
...
WheelEngine::evaluate()
{
    ...
    SbVec3f endPointDir( cosf( zRot), sinf( zRot), 0);
