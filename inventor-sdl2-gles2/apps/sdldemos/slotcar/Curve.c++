...
SbBool
Curve::readInstance(SoInput *in, unsigned short flags)
...
////////////////////////////////////////////////////////////////////////
{
    ...
    int32_t *indList = new int32_t[(numSegs+1)*4+2];
    int32_t *indList2 = new int32_t[(numSegs+1)*4+2];
