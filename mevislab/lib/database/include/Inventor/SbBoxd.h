...
class INVENTOR_API SbBox3d {
  public:
    ...
    friend INVENTOR_API int          operator ==(const SbBox3d &b1, const SbBox3d &b2);
    friend INVENTOR_API int          operator !=(const SbBox3d &b1, const SbBox3d &b2)
        { return !(b1 == b2); }
...
class INVENTOR_API SbXfBox3d : public SbBox3d {
  public:
    ...
    //! Equality comparisons
    friend INVENTOR_API int          operator ==(const SbXfBox3d &b1, const SbXfBox3d &b2);
    friend INVENTOR_API int          operator !=(const SbXfBox3d &b1, const SbXfBox3d &b2)
        { return !(b1 == b2); }
...
class INVENTOR_API SbBox2d {
  public:
    ...
    //! Equality comparisons
    friend INVENTOR_API int          operator ==(const SbBox2d &b1, const SbBox2d &b2);
    friend INVENTOR_API int          operator !=(const SbBox2d &b1, const SbBox2d &b2)
        { return !(b1 == b2); }
