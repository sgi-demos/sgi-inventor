...
class INVENTOR_API SbVec2d {
  public:
    ...
    //! Equality comparison operator
    friend INVENTOR_API int             operator ==(const SbVec2d &v1, const SbVec2d &v2);
    friend INVENTOR_API int             operator !=(const SbVec2d &v1, const SbVec2d &v2)
        { return !(v1 == v2); }
...
class INVENTOR_API SbPlaned {
  public:
    ...
    SbBool              intersect(const SbLined &l,
    ...
    friend INVENTOR_API int             operator ==(const SbPlaned &p1, const SbPlaned &p2);
    friend INVENTOR_API int             operator !=(const SbPlaned &p1, const SbPlaned &p2)
        { return !(p1 == p2); }
...
class INVENTOR_API SbCylinderd {
  ...
  private:
    ...
    static SbBool       unitCylinderIntersect(const SbLined &l,
...
class INVENTOR_API SbSphered {
  public:
    ...
    SbBool      intersect(const SbLined &l, SbVec3d &intersection) const;
    SbBool      intersect(const SbLined &l, SbVec3d &enter, SbVec3d &exit) const;
