...
SoVertexShape::VertexArrayRenderingCB* SoVertexShape::_preVertexArrayRenderingCB = NULL;
SoVertexShape::VertexArrayRenderingCB* SoVertexShape::_postVertexArrayRenderingCB = NULL;
...
void SoVertexShape::setPreVertexArrayRenderingCallback( VertexArrayRenderingCB* cb )
{
  _preVertexArrayRenderingCB = cb;
}

void SoVertexShape::setPostVertexArrayRenderingCallback( VertexArrayRenderingCB* cb )
{
