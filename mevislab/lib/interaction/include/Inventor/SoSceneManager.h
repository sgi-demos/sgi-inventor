...
class INVENTOR_API SoSceneManager {
  public:
    ...
    //! lighting should be turned off (the \b model  field of SoLightModel
    //! should be set to <em>BASE_COLOR</em>),
    //! and the SoColorIndex node should be used to specify colors.
