...
SbBool SoGLVBOElement::matches( const SoElement *elt ) const
{
...
void SoGLVBOElement::updateVBO( SoState* state, VBOType type, SoVBO** vbo, int numBytes /*= 0*/, const void* data /*= NULL*/, uint32_t nodeId /*= 0*/ )
{
