...
void SoVertexArrayIndexer::render(SoState* state, bool useVbo)
{
  ...
  glDrawElements(_type, _numIndices, GL_UNSIGNED_INT, dataPtr);
...
void SoVertexArrayIndexer::setInventorTriangles( int numTriangles, const int32_t* inventorIndices, uint32_t nodeId )
{
  clear();
  _ownsIndices = true;
  _nodeId = nodeId;
...
void SoVertexArrayIndexer::setInventorQuads( int numQuads, const int32_t* inventorIndices, uint32_t nodeId )
{
  clear();
  _ownsIndices = true;
  _nodeId = nodeId;
...
void SoVertexArrayIndexer::setInventorLines( int numLines, const int32_t* inventorIndices, uint32_t nodeId )
{
  clear();
  _ownsIndices = true;
  _nodeId = nodeId;
...
void SoVertexArrayIndexer::setIndices(int numIndices, const int32_t* indices, uint32_t nodeId )
{
  clear();
  _ownsIndices = false;
  _nodeId = nodeId;
