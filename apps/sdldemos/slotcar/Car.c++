...
// Sun-RPC get_myaddress() identified this host for multiplayer car IDs.
// Single-player port: loopback suffices.
static void get_myaddress(struct sockaddr_in *addr)
{
